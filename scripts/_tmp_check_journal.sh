...
ssh -o StrictHostKeyChecking=no "$HOST" 'sudo journalctl -u lobster-backend --since "5 minutes ago" --no-pager -n 200 2>/dev/null | grep -i "预扣\|rix\|402\|insufficient\|billing\|sutui-chat\|chat_trace"'
