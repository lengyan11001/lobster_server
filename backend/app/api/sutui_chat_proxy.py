...
_DEFAULT_VIDEO_GENERATE_MODEL_HINT = (
    getattr(settings, "lobster_default_video_generate_model", None) or "grok-video-3"
...
_LOBSTER_SYSTEM_HINT_BASE = (
    ...
    f"用户未指定模型时 payload.model 填 \"{_DEFAULT_VIDEO_GENERATE_MODEL_HINT}\"；用户未指定时长时不要强行填 duration，由后端按模型默认值处理。"
