...
def test_website_ota_manifest_includes_updater_runtime(tmp_path):
    module = _load_publish_module()
    zip_path = tmp_path / "website-with-updater.zip"
    with zipfile.ZipFile(zip_path, "w") as archive:
        archive.writestr(
            "scripts/check_client_code_update.py",
            "# Auto-generated by scripts/pack_client_code_ota.py --encrypted.\n",
        )
        archive.writestr("scripts/check_client_code_update.pyc", b"compiled")
        archive.writestr("backend/app.pyc", b"compiled")
        archive.writestr("CLIENT_CODE_VERSION.json", "{}")
...
def test_website_ota_with_launcher_does_not_replace_the_desktop_directory(tmp_path):
    module = _load_publish_module()
    zip_path = tmp_path / "website-with-launcher.zip"
    with zipfile.ZipFile(zip_path, "w") as archive:
        archive.writestr("backend/app.py", "# Auto-generated by scripts/pack_client_code_ota.py --encrypted.\n")
        archive.writestr("backend/app.pyc", b"compiled")
        archive.writestr("desktop/launcher.py", "# Auto-generated by scripts/pack_client_code_ota.py --encrypted.\n")
        archive.writestr("desktop/launcher.pyc", b"compiled")
        archive.writestr("CLIENT_CODE_VERSION.json", "{}")
